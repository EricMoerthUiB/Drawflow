export default class Drawflow {
    ...
    click(e) {
        ...
        if (this.editor_mode === 'fixed') {
            ...
            if (e.target.closest(".drawflow_content_node") != null && e.target.closest(".vol") === null) {
    ...
    addNode(name, num_in, num_out, ele_pos_x, ele_pos_y, classoverride, data, html, typenode = false, num_in_bottom = 0, num_out_top = 0) {
        if (this.useuuid) {
